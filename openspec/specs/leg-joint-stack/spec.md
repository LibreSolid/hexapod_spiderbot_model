...
## Purpose
What one servo joint in this robot is: the fork of two plates, the servo standing between them, the horn screwed into one and the bearing seated in the other, and the axis those three define.
